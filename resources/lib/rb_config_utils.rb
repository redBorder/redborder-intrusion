...
module Config_utils
    ...
    def self.hook_hosts(domain, cdomain)
      ...
      hosts_content << "#{domain} data.#{cdomain} kafka.service kafka.#{cdomain} erchef.service.#{cdomain} erchef.#{cdomain} #{cdomain} s3.service.#{cdomain} http2k.#{cdomain} webui.service\n"
